...
UBUNTU_TRANSLATION_DOMAIN="pageheader3.liu-xiao-guo"
...
aptest.commands = bash $$PWD/pageheader3/tests/autopilot/run
aptest.depends  = sub-pageheader3

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/pageheader3/tests/unit
unittest.depends  = sub-pageheader3
